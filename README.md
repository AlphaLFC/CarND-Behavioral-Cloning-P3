...
Note that the `data_generator` will not do data preprocessing. Image resizing operations as well as normalization are integrated in the model architechture.

## Network architechture

I designed a mini-resnet 
